...
import com.dg.flex.data.db.entity.WorkoutExerciseReorder
import com.dg.flex.data.db.entity.ArchiveWorkoutPlan
import com.dg.flex.data.db.entity.ExerciseRecordAndEquipment
...
import com.dg.flex.data.db.entity.WorkoutExerciseUpdateSets
...
import com.dg.flex.data.db.entity.WorkoutRecordFinish
import com.dg.flex.data.db.entity.WorkoutRecordHealthId
import com.dg.flex.data.db.entity.WorkoutRecordStart
import com.dg.flex.data.db.entity.getDuplicatePlanName
...
class Repository @Inject constructor(
    ...
    suspend fun updateProgramDays(programId: Long, daysOfWeek: List<Int>) =
        db.workoutProgramDao.updateDays(WorkoutProgramUpdateDays(programId, daysOfWeek))
