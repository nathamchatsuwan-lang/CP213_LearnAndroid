package com.dg.flex.data.db

import com.dg.flex.data.dataStore
import com.dg.flex.data.db.entity.Exercise
import com.dg.flex.data.db.dao.ExerciseDao
import com.dg.flex.data.db.entity.ExerciseRecord
import com.dg.flex.data.db.dao.ExerciseRecordDao
import com.dg.flex.data.db.entity.ProgramExercise
import com.dg.flex.data.db.dao.ProgramExerciseDao
import com.dg.flex.data.db.entity.WorkoutExercise
import com.dg.flex.data.db.dao.WorkoutExerciseDao
import com.dg.flex.data.db.entity.WorkoutPlan
import com.dg.flex.data.db.dao.WorkoutPlanDao
import com.dg.flex.data.db.entity.WorkoutProgram
import com.dg.flex.data.db.dao.WorkoutProgramDao
import com.dg.flex.data.db.dao.WorkoutRecordDao
...
import com.dg.flex.data.db.entity.getVariation
import com.dg.flex.utils.getLocalizedString
...
val MIGRATION_9_10 = object : Migration(9, 10) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE program ADD COLUMN daysOfWeek TEXT NOT NULL DEFAULT ''")
        // Initialize daysOfWeek based on orderInWorkoutPlan (0 -> "1", 1 -> "2", etc.)
        // This maps Day 1 to Monday, Day 2 to Tuesday, ..., Day 7 to Sunday
        db.execSQL("UPDATE program SET daysOfWeek = CAST((orderInWorkoutPlan + 1) AS TEXT) WHERE orderInWorkoutPlan < 7")
    }
}
